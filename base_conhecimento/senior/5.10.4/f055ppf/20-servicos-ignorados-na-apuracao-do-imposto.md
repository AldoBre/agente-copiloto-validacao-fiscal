# Serviços ignorados na apuração do imposto
...
---
Cadastre quais serviços devem ser ignorados na apuração dos impostos tipo "5 - ISS "e "65 - ISS Retido".

Data base   
Define a validade inicial desta base.

Código do serviço   
Define o código do serviço, conforme Lei Complementar 116/03.
