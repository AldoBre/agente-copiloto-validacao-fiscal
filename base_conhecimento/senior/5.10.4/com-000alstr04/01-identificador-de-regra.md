...
> **URL:** https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/identificadores_regras/com_000alstr04.htm  
> **Trilha:**   
> **Telas citadas:** —  
> **Identificadores de regras:** COM-000ALSTR04
...
**Finalidade:** Alterar a sugestão do código da situação tributária de COFINS do item ou a natureza de receita do PIS e COFINS.

**Características:** Chamado na sugestão do código da situação tributária, em notas fiscais de compra e venda, para produtos e serviços.  

A partir da versão 5.7.3.1 disponibilizado as variáveis:  
 ComNNatPis - Natureza de receita do PIS.  
 ComNNatCof - Natureza de receita do COFINS.  

A partir da versão 5.8.1.13:  
...
| ComNNatPis | NÚMERO | Natureza de receita do PIS. | S |
| ComNNatCof | NÚMERO | Natureza de receita do COFINS. | S |
