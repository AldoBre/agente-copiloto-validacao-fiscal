...
> **URL:** https://documentacao.senior.com.br/gestaoempresarialerp/5.10.4/identificadores_regras/com_000alcof01.htm  
> **Trilha:**   
> **Telas citadas:** F000INE  
> **Identificadores de regras:** COM-000ALCOF01, CPR-000MTNEL01
...
**Finalidade:** alterar o valor base e o valor da COFINS a recuperar nas notas fiscais de entrada, ordem de compra e notas fiscais de saída.

**Características:** chamado nos cálculos da notas fiscais de entrada, ordem de compra e notas fiscais de saída, podendo ser analisado pela variável **VSOrigem**. Para saber se é produto ou serviço, analise a variável **VSProSer**.

**Tela:** notas fiscais e ordens de compra.

**Transação:** tem de estar ligado a uma transação.

**Regra:** este exemplo subtrai o valor do ICMS do valor base do COFINS a recuperar, calculando o novo valor.

|  |
| --- |
| ``` se (VSProSer = P)   inicio   se (VSVlrBcr > VSVlrIcm)     inicio     VSVlrBcr = VSVlrBcr - VSVlrIcm;     VSVlrCor = (VSVlrBcr * (VSPerCod/100));     fim;   fim; ``` |

**Variáveis Disponibilizadas:**

| Nome | Tipo | Observações | Retorna Valor |
| --- | --- | --- | --- |
| CprNPerCor | NÚMERO | Percentual de Cofins a recuperar | S |
| CprNAliCof | NÚMERO | Alíquota por Valor do COFINS a recuperar (Estorno devolução) | S |
...
| VSVlrStc | NÚMERO | Valor substituição COFINS | N |
...
| VSPerCod | NÚMERO | Percentual de COFINS a recuperar | N |
...
| VSVLRBCR | NÚMERO | Valor base do COFINS a recuperar | S |
| VSVLRCOR | NÚMERO | Valor do COFINS a recuperar | S |
| VSRedIss | NÚMERO | Alterar valor base e valor do COFINS a recuperar | N |
